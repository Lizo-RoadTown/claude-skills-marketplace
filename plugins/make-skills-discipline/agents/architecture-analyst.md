...
1. **Automatic** — SessionStart hook in the make-skills-discipline plugin runs the snapshot + diff scripts and invokes you with the resulting JSON paths.

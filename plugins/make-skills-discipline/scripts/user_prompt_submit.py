...
def _write_memory_stub(cwd: str, prompt: str) -> Path | None:
    ...
    try:
        ...
        body = (
            "---\n"
            f"name: remember-{ts}\n"
            "description: STUB — created automatically by make-skills-discipline UserPromptSubmit hook on detection of repetition phrasing. Fill in the rule + Why + How to apply lines as the response is composed; this stub is meant to be edited before the turn ends.\n"
            "metadata:\n"
            "  type: feedback\n"
            "  auto_created: true\n"
            "---\n\n"
